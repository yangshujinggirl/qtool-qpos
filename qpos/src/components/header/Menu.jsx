...
const menus=[ {icon:'icon_member.png',title:'会员管理',router:'/member'},
...
function Menuuse() {
  return (
    <div className='clearfix'>
      ...
      <ul className='clearfix' style={{float:'left'}}>
        {
...
function Menuicon() {
  return (
    <div className='menuicon'>
      <div className='menuiconcount'><Link to='/cashier'><img src={require('../../images/icon_back.png')}/></Link></div>
    </div>
  );
}
