...
class Searchcomponent extends React.Component {
    ...
    Hindok=()=>{
      ...
      if(this.props.pdCheckId){
        ...
        GetServerData('qerp.pos.pd.check.adjust',values)
        .then((json) => {
          if(json.code =='0'){
      ...
      return(
        <div className='clearfix'>
      		<div className='fl clearfix mb10'>
      			<div className='btn' onClick={this.download.bind(this)}>
              <Buttonico text='下载盘点差异'/>
            </div>
      		</div>
    			<div className='fr'>
      			<div className='searchselect clearfix'>
              <div className='fl btn ml20'
                onClick={this.writelog.bind(this)}>
                <Link to='/inventory'><Buttonico text='暂不损益'/></Link>
              </div>
      				<div className='fl btn ml20' onClick={this.Hindok.bind(this)}>
                <Buttonico text='确定损益'/>
              </div>
            </div>
 			    </div>
...
class EditableTable extends React.Component {
    ...
    setdatas=(messages)=>{
      ...
      GetServerData('qerp.pos.pd.check.info',messages)
      .then((json) => {
        if(json.code=='0'){
        ...
        <div className='spin-con-box'>
          ...
          <div className='counters'>
            <Searchcomponent
              ...
              pdCheckId={this.props.pdCheckId}
              initpdCheckId={this.initpdCheckId}
              ref='user'/>
            <EditableTable
              dispatch={this.props.dispatch}
              pdCheckId={this.props.pdCheckId}
              dataSources={this.dataSources.bind(this)}
